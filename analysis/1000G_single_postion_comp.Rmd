...
```{r echo=FALSE}
plot_pos_stat("ALL", "AT_CG", kl_by_position, title_text = "Relative Entropy by Relative Position: ", ylab_text = "Relative Entropy")
```
...
```{r echo=FALSE}
plot_pos_stat("AFR", "AT_CG", re_by_position, title_text = "Relative Entropy by Relative Position: ", ylab_text = "Relative Entropy")
```
...
```{r echo=FALSE}
plot_pos_stat("AMR", "AT_CG", re_by_position, title_text = "Relative Entropy by Relative Position: ", ylab_text = "Relative Entropy")
```

#### EAS

```{r echo=FALSE}
plot_pos_stat("EAS", "AT_CG", re_by_position, title_text = "Relative Entropy by Relative Position: ", ylab_text = "Relative Entropy")
```

#### EUR

```{r echo=FALSE}
plot_pos_stat("EUR", "AT_CG", re_by_position, title_text = "Relative Entropy by Relative Position: ", ylab_text = "Relative Entropy")
```

#### SAS

```{r echo=FALSE}
plot_pos_stat("SAS", "AT_CG", re_by_position, title_text = "Relative Entropy by Relative Position: ", ylab_text = "Relative Entropy")
```
...
df_wide_at_cg <- 
  df_at_cg %>%
  select(Nuc, rp, pop, kl_r) %>%
  pivot_wider(names_from = pop, values_from = kl_r)

df_pos_at_cg <- df_wide_at_cg %>%
  group_by(rp) %>%
  summarize(across(AFR:SAS, ~sum(.)))
...
In the above plot we can see that across all positions, the results for the AFR super-population are highly correlated with the other super-populations. Let's wrap the above analyses into a function and run them on the other subtypes.

```{r}
corr_analysis <- function(subtype, r_start = 1, stat_col = "kl_r"){
