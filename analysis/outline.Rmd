...
* Didn't really touch on between-population differences seen in things like 3-mer mutation subtype enrichments in 1000G populations
...
* Phrase problem in terms of a categorization problem: given sequence at ... positions, can we distinguish between singletons and randomly sampled controls?
    * My impression is that metrics we get from this perspective are easier to interpret in regards to the goal of builing a "better mutation rate estimate"
